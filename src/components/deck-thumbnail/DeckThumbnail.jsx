...
export const DeckThumbnail = ({ deckImg }) => {
  ...
  return (
    <div className="deck-thumbnail" style={{ "--background-img": `url(${imgArray[deckImg - 1]})` }}>
      <div className="deck-details">
        <div className="thumb-deck-name">Deck Name</div>
        <div className="thumb-deck-info">Deck Info </div>
      </div>
    </div>
  );
};
